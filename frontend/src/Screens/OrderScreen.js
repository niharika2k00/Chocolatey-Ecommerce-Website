              ...
              <ListGroup variant="flush">
                <ListGroup.Item className="Orderbkgrnd">
                  ...
                  <p style={{ margin: "0 0 3px 0" }}>
                    ...
                    <span id="Ordersubhead">{Order.user.name}</span>
                  </p>
                  <p style={{ margin: "0 0 3px 0" }}>
                    <strong style={{ fontSize: "1.05rem " }}>Email : </strong>{" "}
                    <span id="Ordersubhead">{Order.user.email}</span>
                  </p>
                ...
                <ListGroup.Item className="Orderbkgrnd">
                  ...
                  <p style={{ margin: "0 0 1.2rem 0" }}>
                    ...
                    <span id="Ordersubhead">{Order.paymentMethod}</span>
                  </p>

                  {Order.isPaid ? (
                    <Mess variant="success"> Paid on {Order.paid_at} </Mess>
                  ) : (
                    ...
                    <ListGroup.Item>
                      ...
                      {Order.paymentMethod === "Cash on Delivery" ? (
                        ...
                        <PayPalButton
                          ...
                          currency="USD" // INR for Indian Rupees but not working in sandbox
