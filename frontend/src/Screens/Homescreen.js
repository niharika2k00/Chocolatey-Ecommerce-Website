  ...
  return (
    <div>
          ...
          <Dropdown>
            ...
            <Dropdown.Menu style={{ backgroundColor: "#474448" }}>
              ...
              <Dropdown.Item onClick={() => sortLowToHigh()}>
                {" "}
                <Link to="/home">Low to High</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sortHIghToLow()}>
                {" "}
                <Link to="/home">High to Low</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sortAscending()}>
                <Link to="/home">A - Z</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sortLess100()}>
                <Link to="/home">Price less than 100</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sortMore250()}>
                <Link to="/home">Price more than 250</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sortBestSelling("Best Selling")}>
                <Link to="/home">Best Selling</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sort("Mother's Day")}>
                <Link to="/home">Mother's Day</Link>{" "}
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sort("Valentines Day")}>
                <Link to="/home">Valentines Day</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sort("Christmas Special")}>
                <Link to="/home">Christmas Special</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sort("Gift Boxes")}>
                <Link to="/home">Gift Boxes</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sort("Brownies")}>
                <Link to="/home">Brownies</Link>
              </Dropdown.Item>
              <Dropdown.Item onClick={() => sort("Cup Cakes")}>
                <Link to="/home">Cup Cakes</Link>
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </div>
      ...
      {loading ? (
        ...
        <Mess variant="danger"> {error}</Mess> //<h3>{error}</h3>
      ) : (
        <Row style={{ paddingBottom: "2rem" }}>
          {currCartItems &&
            currCartItems.map((product) => (
              <Col
                key={product._id}
                xs={12}
                sm={12}
